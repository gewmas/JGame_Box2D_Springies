 ...
 * masses attached its endpoints. The oscillation of the muscle is defined by the amplitude
 * multiplied
 * by a sinusoidal function. A timer is incremented in the move function to cause the sinusoidal
 * function to vary.
 * 
 * 
...
public class Muscle extends Spring {
    ...
    /**
     * Moves muscle object by calling setLength() and springMove() and increments timer for
     * sinusoidal motion
     */
    @Override
    public void move () {
